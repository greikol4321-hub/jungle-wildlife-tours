...
const particles = [
  { top: "18%", left: "8%", size: 2.5, color: "bg-emerald", opacity: "opacity-20", delay: 0 },
  { top: "50%", right: "15%", size: 2, color: "bg-sand", opacity: "opacity-15", delay: 0.5 },
  { top: "70%", left: "20%", size: 1.5, color: "bg-emerald", opacity: "opacity-15", delay: 1 },
  { top: "30%", right: "35%", size: 3, color: "bg-emerald", opacity: "opacity-10", delay: 0.3 },
  { top: "80%", right: "25%", size: 1.8, color: "bg-sand", opacity: "opacity-10", delay: 0.8 },
];

export function ToursHero({ locale }: ToursHeroProps) {
  ...
  const bgY = useTransform(scrollYProgress, [0, 1], reduce ? ["0%", "0%"] : ["0%", "30%"]);
  ...
  const contentY = useTransform(scrollYProgress, [0, 0.6], reduce ? [0, 0] : [0, -60]);
        ...
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="block mt-2 text-emerald font-extrabold tracking-[-0.04em]">
              {locale === "es" ? "en la selva" : "in the wild"}
            </span>
          </m.h1>
