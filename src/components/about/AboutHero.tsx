...
const particles = [
  ...
  { top: "45%", right: "10%", size: 2, color: "bg-sand", opacity: "opacity-12", delay: 0.6 },
  { top: "65%", left: "22%", size: 1.5, color: "bg-emerald", opacity: "opacity-10", delay: 1.2 },
  { top: "28%", right: "28%", size: 3, color: "bg-emerald", opacity: "opacity-8", delay: 0.3 },
];
