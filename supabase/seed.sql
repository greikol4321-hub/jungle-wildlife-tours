-- Seed completo con todos los campos de demo data
insert into public.tours (slug, category, title_es, title_en, description_es, description_en, full_description_es, full_description_en, duration_minutes, difficulty, min_age, max_people, price_usd, child_price_pct, child_price_usd, languages, is_active, display_order, includes, excludes, itinerary)
values
  (
    ...
    'Recorrido guiado por los senderos del parque para observar fauna del Pacífico central.',
    'Guided trail walk through the park to observe wildlife in the central Pacific.',
    ...
    '[
      {"time": "8:00", "title": "Inicio del tour", "description": "El pickup se coordina según tu ubicación de hospedaje — te confirmamos la hora al reservar."}
    ]'::jsonb
  ),
  (
    'caminata-manglar-damas',
    'mangrove',
    'Caminata en manglar - Isla Damas',
    'Mangrove walk - Damas Island',
    'Caminata guiada por los senderos del manglar de Isla Damas, cerca de Quepos.',
    'Guided walk through the Damas Island mangrove trails near Quepos.',
    ...
    '[
      {"time": "6:00", "title": "Salida desde Quepos", "description": "Encuentro en el punto de encuentro. Instrucciones de seguridad y breve introducción al ecosistema del manglar."},
      {"time": "6:30", "title": "Ingreso al sendero del manglar", "description": "Caminata por los senderos de Isla Damas. Avistamiento de aves acuáticas, monos y cocodrilos."},
      {"time": "8:00", "title": "Zona de avistamiento intensivo", "description": "Recorrido guiado por los senderos entre la vegetación. Observación de fauna con telescopio profesional."},
      {"time": "9:30", "title": "Regreso y cierre", "description": "Retorno a Quepos. Café o fresco natural incluido."}
    ]'::jsonb
  ),
  (
    'caminata-nocturna',
    ...
    'Caminata nocturna',
    'Night jungle walk',
    'Caminata guiada de noche para observar anfibios, insectos y fauna activa en la oscuridad.',
    'Night guided walk to observe frogs, insects, and active wildlife in the dark.',
    ...
    '{"Transporte al punto de encuentro", "Alimentación y bebidas", "Repelente (traer propio, biodegradable recomendado)", "Propinas"}',
    '[
      {"time": "17:45", "title": "Encuentro en la oficina", "description": "Preparación del equipo: linternas frontal y de mano. Briefing de seguridad."},
      {"time": "18:00", "title": "Inicio del recorrido nocturno", "description": "Ingreso al sendero. La transición día-noche revela el cambio de guardia entre especies."},
      {"time": "19:00", "title": "Zona de avistamiento intensivo", "description": "Búsqueda de anfibios, insectos, serpientes y mamíferos nocturnos. Uso de luz roja para no alterar la fauna."},
      {"time": "20:00", "title": "Cierre y reflexión", "description": "Último tramo del sendero. Conversación sobre conservación y el rol de la fauna nocturna."}
    ]'::jsonb
  )
